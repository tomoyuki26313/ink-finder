...
export default function JapaneseBlogPostPage() {
    ...
    return (
      <div className="min-h-screen bg-[#E6E6E6] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-8">記事が見つかりません</p>
          <Link
            href="/ja/blog"
            ...
            <div className="flex flex-wrap items-center gap-6 text-gray-600 mb-8">
              ...
              {post.view_count > 0 && (
                <div className="flex items-center gap-2">
                  ...
                  <span>{post.view_count.toLocaleString()} 回表示</span>
                </div>
              )}
              <button
                onClick={handleShare}
          ...
          <article className="bg-white rounded-lg p-8 md:p-12 shadow-sm">
            ...
            <div 
              ...
              dangerouslySetInnerHTML={{ 
                __html: post.content_ja.replace(/\n/g, '<br><br>') 
              }}
            />
          </article>
        </div>
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <h3 className="text-lg font-bold text-gray-900 mb-2 line-clamp-2">
                      {relatedPost.title_ja}
                    </h3>

                    <p className="text-gray-600 text-sm mb-3 line-clamp-2">
                      {relatedPost.excerpt_ja}
                    </p>
